...
const defaultCornerStyle = { height: 32, width: 32, borderWidth: 6, borderColor: '#FFFFFF' };
const defaultScanBarStyle = { alignSelf:'center', width:180, backgroundColor: '#F9F9F9F9',height:2 };
